...
if (isset($_POST['vendor_id']) && isset($_POST['bold_text']) && isset($_POST['img_rel_url']) && isset($_POST['fine_print_text']) && isset($_POST['highlight_text']) && isset($_POST['valid_from']) && isset($_POST['valid_until']) && isset($_POST['original_price']) && isset($_POST['current_price']) && isset($_POST['num_thumbs_up']) && isset($_POST['num_thumbs_down']) && isset($_POST['is_limited_availability']) && isset($_POST['is_limited_time_offer']) && isset($_POST['num_bought']))  {
    ...
    $db = new DbHandler();
    $res = $db->insertDeal($vendor_id, $bold_text, $img_rel_url, $highlight_text, $fine_print_text, $original_price, $current_price, $num_bought, $num_thumbs_up, $num_thumbs_down, $valid_from, $valid_until, $is_limited_time_offer, $is_limited_availability);
